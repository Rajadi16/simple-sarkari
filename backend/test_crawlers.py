...
ADAPTERS = {
    ...
    # ── New Karnataka / education sources ─────────────────────────────────────
    "bescom": {
        "class": "crawlers.drupal_karnataka.DrupalKarnatakaAdapter",
        "source": {
    ...
    "kptcl": {
        ...
        "source": {
            ...
            "base_domains": ["kptcl.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "KPTCL",
            "category": "utilities",
    ...
    "kerc": {
        ...
        "source": {
            ...
            "base_domains": ["kerc.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "KERC",
            "category": "utilities",
    ...
    "mescom": {
        ...
        "source": {
            ...
            "base_domains": ["mescom.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "MESCOM",
            "category": "utilities",
    ...
    "bwssb": {
        ...
        "source": {
            ...
            "base_domains": ["bwssb.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "BWSSB",
            "category": "water",
    ...
    "kuwsdb": {
        ...
        "source": {
            ...
            "base_domains": ["kuwsdb.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "KUWSDB",
            "category": "water",
    ...
    "kspcb": {
        ...
        "source": {
            ...
            "base_domains": ["kspcb.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "KSPCB",
    ...
    "kseab": {
        ...
        "source": {
            ...
            "base_domains": ["kseab.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "KSEAB",
            "category": "education",
    ...
    "vtu": {
        "class": "crawlers.wordpress_karnataka.WordPressKarnatakaAdapter",
        "source": {
            "source_id": "vtu", "name": "Visvesvaraya Technological University (VTU)",
            "adapter": "wordpress_karnataka",
            "base_domains": ["vtu.ac.in", "www.vtu.ac.in"], "government_level": "state",
            "state": "Karnataka", "department": "VTU",
            "category": "education",
    ...
    "ssp_karnataka": {
        "class": "crawlers.ssp_karnataka.SspKarnatakaAdapter",
        "source": {
            "source_id": "ssp_karnataka", "name": "SSP Karnataka",
            "adapter": "ssp_karnataka",
            "base_domains": ["ssp.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "SSP Karnataka",
    ...
    "sevasindhu": {
        "class": "crawlers.sevasindhu.SevaSindhuAdapter",
        "source": {
            "source_id": "sevasindhu", "name": "Seva Sindhu Karnataka",
            "adapter": "sevasindhu",
            "base_domains": ["sevasindhu.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "Karnataka e-Governance Centre",
            "category": "e_governance",
    ...
    "gba": {
        ...
        "source": {
            ...
            "base_domains": ["gba.karnataka.gov.in"], "government_level": "state",
            "state": "Karnataka", "department": "GBA",
            "category": "civic",
    ...
    "ksrtc": {
        ...
        "source": {
            ...
            "adapter": "drupal_karnataka",
            "base_domains": ["ksrtc.in", "www.ksrtc.in"], "government_level": "state",
            "state": "Karnataka", "department": "KSRTC",
            "category": "transport",
